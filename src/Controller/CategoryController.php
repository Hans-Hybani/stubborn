...
class CategoryController extends AbstractController
{
    ...
    public function addCategory(EntityManagerInterface $entityManager, Request $request):Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash('success','votre categorie a été créé');
    ...
    public function update(Category $category, EntityManagerInterface $entityManager, Request $request):Response{
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash('success','votre categorie a été modifier');
    ...
    public function delete(Category $category, EntityManagerInterface $entityManager):Response{
        ...
        $this->addFlash('danger','votre categorie a été supprimer');
